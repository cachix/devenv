...
- Fixed interactive TUI commands such as `devenv up` spinning at 100%+ CPU after a terminal host closes without delivering SIGHUP. The TUI now shuts down when its terminal input is revoked or hung up.
