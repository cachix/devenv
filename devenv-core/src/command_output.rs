//! Output types for Nix command execution.
//!
//! This module contains types that describe the output of Nix commands,
//! including file and environment variable dependencies tracked during evaluation.
...
/// Output of a Nix command execution.
