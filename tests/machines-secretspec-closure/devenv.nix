...

{
  ...
  machines.locked-root = {
    system = pkgs.stdenv.hostPlatform.system;
    target.host = "root@locked-root.example.com";
    hardware.facter = null;
    nixos = {
      system.stateVersion = "24.11";
      networking.hostName = "locked-root-test";
      users.users.root.hashedPassword = "!";
    };
  };

  machines.locked-initial-root = {
    system = pkgs.stdenv.hostPlatform.system;
    target.host = "root@locked-initial-root.example.com";
    hardware.facter = null;
    nixos = {
      system.stateVersion = "24.11";
      networking.hostName = "locked-initial-root-test";
