...
# Test 5: Multiple profiles with priority handling (profile-a + profile-b)
...
if check_env_var "$json_output" "MERGE_TEST" "profile-b" && \
  ...
  echo "✓ Multiple profiles merged with correct priority (mkForce > mkDefault) and all packages"
else
