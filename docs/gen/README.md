...
Generates the complete options data used by the Astro reference page at
[`/docs/src/data/options.json`](../src/data/options.json).

### `devenv-generate-individual-docs`

Generates individual documentation pages for each language, service, and
process manager in
[`/docs/src/content/docs/`](../src/content/docs/) directories. Combines manual
docs from [`/docs/src/individual-docs/`](../src/individual-docs/) with
