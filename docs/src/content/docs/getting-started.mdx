...
<Tabs>
  <TabItem label="Newcomers">
    ```
    nix-env --install --attr devenv -f https://github.com/NixOS/nixpkgs/tarball/nixpkgs-unstable
    ```
  </TabItem>
  <TabItem label="Nix profiles (requires experimental flags)">
    ```
    nix profile install nixpkgs#devenv
    ```
  </TabItem>
  <TabItem label="NixOS/nix-darwin">
...
<Tabs>
  <TabItem label="Nix env (newcomers)">
    ```
  ...
  <TabItem label="NixOS/nix-darwin/home-manager">
