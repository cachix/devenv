---
title: "Composing using imports"
---

You can compose environments either locally or by referencing [inputs](/inputs/).
...
Combine this with [profiles](/profiles/) to define one shared configuration that adapts to each project.
...
See [devenv.yaml reference](/reference/yaml-options/#imports) for all supported import options.
