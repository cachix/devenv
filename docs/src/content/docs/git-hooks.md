...
This integration _requires_ to have the `git-hooks` input the `devenv.yaml` file, as in [the inputs page](/inputs/).
...
See [the list of all available hooks](/reference/options/#git-hooks).
