---
title: "devenv 0.6: Generating containers and instant shell activation"
date: 2023-03-02
authors:
  - name: "Domen Kožar"
...
- [How to copy the containers to a registry](/containers/#copying-a-container-to-a-registry)
- [How to conditionalize environment based on native/container target](/containers/#changing-the-environment-based-on-the-build-type)
...
With the latest [direnv.net integration](/integrations/direnv/),
