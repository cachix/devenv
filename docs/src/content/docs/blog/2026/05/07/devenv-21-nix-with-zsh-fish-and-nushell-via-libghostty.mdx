---
title: "devenv 2.1: Nix with zsh, fish, and nushell via libghostty"
date: 2026-05-07
authors:
  - name: "Domen Kožar"
...
[devenv 2.0](/blog/2026/03/05/devenv-20-a-fresh-interface-to-nix/) gave you hot reload, the status line, and instant cache hits, but `devenv shell` always dropped you into bash, and you still needed `direnv` for activation on `cd`.
...
[`devenv hook`](/auto-activation/) replaces direnv for `cd` based activation. Add one line to your shell config:
