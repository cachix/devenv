---
title: "devenv 2.2: attach to running processes and persistent out-of-tree environments"
date: 2026-07-28
authors:
  - name: "Domen Kožar"
...
The native shell integration added in 2.1 now loads automatically in fish and nushell through their vendor configuration mechanisms. Bash and zsh have no equivalent, so they still need the one-line [`devenv hook`](/auto-activation/) setup in your shell configuration.
