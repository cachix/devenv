...
It has been 3 days since [0.2](/blog/2022/11/14/devenv-02/) release, so it's time for 0.3:

# Highlights

- We have a [roadmap](/blog/2024/10/22/devenv-is-switching-its-nix-implementation-to-tvix/)!
