...
It builds the shell and runs any defined [git hooks](/git-hooks/) against your repository.
...
If you're using devenv with [Nix Flakes](/guides/using-with-flakes/) and `nix develop` to set the shell for a step, you may need to wrap the command in bash.
