...
remain reproducible. See [Installing a specific version](/packages/#installing-a-specific-version) for usage
...
See [Pinning several packages](/packages/#pinning-several-packages) for what minimizing decides, and
