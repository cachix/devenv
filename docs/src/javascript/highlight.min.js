...
aliases:["console","shellsession"],contains:[{className:"meta.prompt",
begin:/^\s{0,3}[/~\w\d[\]()@-]*[>%$#][ ]?/,starts:{end:/[^\\](?=\s*$)/,
subLanguage:"bash"}}]})})();hljs.registerLanguage("shell",s)})();/*! `nix` grammar compiled for Highlight.js 11.9.0 */
...
aliases:["yml"],contains:b}}})();hljs.registerLanguage("yaml",e)})();/*! `ruby` grammar compiled for Highlight.js 11.9.0 */
(()=>{var e=(()=>{"use strict";return e=>{
...
;hljs.registerLanguage("ruby",e)})();/*! `ini` grammar compiled for Highlight.js 11.9.0 */
